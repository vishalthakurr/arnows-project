      ...
      <div className="container  pt-[5rem] flex flex-col-reverse  md:flex-row  md:px-4 lg:px-6   mx-auto items-center justify-center">
        <div className="right flex flex-col bg-white px-8 py-2 rounded-md  md:w-2/6 shadow-2xl text-md relative">
          ...
          <form onSubmit={Createlogin} method="POST">
            <input
              className="px-5 w-full h-12 my-2 rounded-md border-2 border-x-gray-300 outline-blue-600"
              type="text"
            ...
            <div className=" flex flex-row">
              <input
                id="showhide"
                className=" w-full  relative px-5 h-12 my-2 rounded-md border-2 border-x-gray-300 outline-blue-600"
                type="password"
            ...
            <button
              type="submit"
              className=" mx-40  my-3 bg-blue-600 text-white  font-bold rounded-md p-3 hover:bg-blue-700"
            >
              Sign In
            </button>
          </form>
          ...
          <Link href="/Signup">
            <button className=" my-3  bg-green-600 text-white w-fit  m-auto font-bold rounded-md p-3 hover:bg-green-700">
              Create New Account
            </button>
          </Link>
        </div>
